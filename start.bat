...
if "%~1"=="--serve" (
  call :needkey DEEPGRAM_API_KEY "Deepgram key (optional; press Enter to skip)"
  call :needkey ELEVENLABS_API_KEY "ElevenLabs API key (optional; press Enter to skip)"
)
if "%~1"=="--voice" (
